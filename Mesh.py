...
class Mesh:
    def __init__(self):
        self._current_node = 0  # last created node index
        self.nodes = []
        self.elements = []
        self.points = []
        self.lines = []
    ...
    def elements_on_line(self, num: int, lines: list):
        ...
        for line in lines:
            ...
            if line.point1.node_number is None:
                ...
                line.point1.node_number = self._current_node
                self.lines.append(line)
                node1 = Node(x=line.point1.x, y=line.point1.y, z=line.point1.z, index=self._current_node)
            ...
            for n in range(1, num):
                ...
                node2 = Node(x=x, y=y, z=z, index=self._current_node)
            ...
            if line.point2.node_number is None:
                ...
                self._current_node = self._current_node + 1
                line.point2.node_number = self._current_node
                self.lines.append(line)
                node2 = Node(x=line.point2.x, y=line.point2.y, z=line.point2.z, index=self._current_node)
                self.nodes.append(node2)
